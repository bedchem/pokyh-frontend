...
export const alt = 'POKYH Anmelden – Schulapp LBS Brixen';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <p style={{ fontSize: 40, color: 'white', fontWeight: 700, margin: '0 0 16px 0' }}>Anmelden</p>
        <p style={{ fontSize: 26, color: '#8b8fa8', margin: 0, textAlign: 'center' }}>
          Mit deinem Schulaccount einloggen · LBS Brixen
        </p>
