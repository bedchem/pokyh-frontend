...
const STEPS = [
  {
    ...
    body: (
      <>
        Gehe auf <strong><a href="https://github.com/bedchem/POKYH_IOS/releases" target="_blank" rel="noopener noreferrer">https://github.com/bedchem/POKYH_IOS/releases</a></strong> in deinem Browser.
      </>
    ),
    icon: (
