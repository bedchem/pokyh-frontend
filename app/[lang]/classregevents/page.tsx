...
function fmtDateLongWith(d: number, months: string[]): string {
...
export default function ClassregEventsPage() {
  ...
  const MONTH_SHORT = monthShort(locale);
  const fmtDateLong = (d: number) => fmtDateLongWith(d, MONTH_SHORT);
  ...
  const FILTER_OPTIONS: { value: FilterMode; label: string }[] = [
    ...
    { value: '1m', label: t('filter1m') },
    { value: '3m', label: t('filter3m') },
  ];
          ...
          {loading ? (
            ...
            <main className="cr-dashboard">
              <div className="page-head">
                <div>
                  <h1 className="page-title">{t('schoolYear', { year: schoolYearLabel })}</h1>
                  <div className="page-sub">
                    {t('summary', { entries: stats.total, subjects: stats.subjects })}
                    {stats.latest ? t('asOf', { date: fmtDateLong(stats.latest) }) : ''}
                  </div>
                </div>
              ...
              <section className="kpis">
                <div className="card">
                  <div className="card-hd">
                    <div>
                      <div className="card-title">{t('totalEntries')}</div>
                      <div className="card-sub">{t('wholeYear')}</div>
                    </div>
                  </div>
                ...
                <div className="card">
                  <div className="card-hd">
                    <div>
                      ...
                      <div className="card-sub">{t('affectedSubjects')}</div>
                    </div>
                  </div>
                ...
                <div className="card">
                  <div className="card-hd">
                    <div>
                      <div className="card-title">{t('lastEntry')}</div>
                      <div className="card-sub">{t('newestEntry')}</div>
                    </div>
                  </div>
                ...
                <div className="card">
                  <div className="card-hd">
                    <div>
                      <div className="card-title">{t('topCategory')}</div>
                      <div className="card-sub">{t('byCount')}</div>
                    </div>
                  </div>
              ...
              <section className="timeline-wrap">
                <div className="timeline-head">
                  <div className="timeline-head-title">{t('entries')}</div>
                ...
                <div className="timeline-list">
                  {displayed.length === 0 ? (
                    <div className="timeline-empty">{t('noEntriesRange')}</div>
                  ) : (
